...
var questions = []Question{
	...
	{Body: "На что первое ты обратил внимание, когда остановился? Если это что-то вокруг тебя, пришли фото.", Order: "random"},
	...
	{Body: "Что двигается, пока ты смотришь? Если можешь - сфотографируй.", Order: "random"},
	{Body: "Какой предмет вокруг больше всего похож на тебя? На твои чувства? Пришли его фото.", Order: "random"},
	{Body: "Попробуй переназвать любой предмет вокруг, исходя из его вида и ощущений от него. Опиши процесс. Можешь приложить фото.", Order: "random"},
	{Body: "Представь ощущение от прикосновения к любому предмету недалеко от себя. Потрогай его. Похоже? Чем отличается? Можешь приложить фото.", Order: "random"},
	{Body: "Обрати внимание на дыхание, какое оно?", Order: "random"},
	{Body: "Чего ты сейчас хочешь?", Order: "random"},
	{Body: "На что смотреть приятнее всего? Почему это приятно? Можешь приложить фото.", Order: "random"},
	{Body: "Где ты находишься? И как тебе здесь? Что бы ты изменил? Можешь приложить фото.", Order: "random"},
	...
	{Body: "Осмотрись. Что тебе здесь нравится? А что нет? Можешь приложить фото.", Order: "random"},
	{Body: "Попробуй почувствовать материальность любого предмета рядом. Как это? Можешь приложить фото.", Order: "random"},
	{Body: "Какой цвет тебе сейчас ближе из всех вокруг? Как ты себя чувствуешь, смотря на него? Можешь приложить фото.", Order: "random"},
	{Body: "Почему ты последовал/не последовал предложению остановиться?", Order: "random"},
	{Body: `
Вспомни, как ты останавливался. Задай себе последние вопросы - изменилось ли что-то в тебе? В том, что ты замечаешь? Продолжишь ли ты останавливаться самостоятельно?

Расскажи о своих впечатлениях и том, как бот и остановки повлияли на тебя.
Попрощайся с ботом и жди новых встреч.

Благодарим тебя за участие.

Доброго пути)`, Order: "last"},
}
